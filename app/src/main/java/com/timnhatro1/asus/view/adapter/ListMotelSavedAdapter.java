...
public class ListMotelSavedAdapter extends RecyclerView.Adapter<ListMotelSavedAdapter.ViewHolder> {
    private Context context;
    private List<MotelModel> listModelSaved;
    private OnClickItemListener onClickedItem;

    public ListMotelSavedAdapter(Context context, List<MotelModel> listModelSaved, OnClickItemListener onClickedItem) {
        this.context = context;
        this.listModelSaved = listModelSaved;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        MotelModel model = listModelSaved.get(position);
        ...
        holder.mViewItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (onClickedItem!=null)
                    onClickedItem.onClickItem(position);
            }
        });
//        if (model.isSave()) {
...
//        }
    ...
    public int getItemCount() {
        return listModelSaved == null ? 0 : listModelSaved.size();
    }
    @Override
